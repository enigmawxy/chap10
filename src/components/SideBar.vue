<template>
  <div class="sidebar bg-white border-r h-screen flex flex-col items-center py-4">
    <!-- Logo/Avatar at top -->
    <div class="mb-8">
      <div class="w-10 h-10 rounded-full bg-orange-400 flex items-center justify-center text-white font-bold">
        T
      </div>
    </div>
